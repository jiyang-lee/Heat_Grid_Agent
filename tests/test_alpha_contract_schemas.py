...
MODEL_HANDOFF = Path("model_handoff/heatgrid_ml_models_2026-06-25")
ANOMALY_META = MODEL_HANDOFF / "anomaly" / "baseline_model_metadata.json"
RISK_META = MODEL_HANDOFF / "risk" / "risk_model_metadata.json"
LEADTIME_META = MODEL_HANDOFF / "leadtime" / "leadtime_bucket_model_promoted_metadata.json"
