...
async def tools_for_input(
    module: ModuleType,
    card_id: str,
    source_input: dict[str, object],
) -> dict[str, object]:
    external_context = await module.external_context_for(card_id, source_input)
...
async def test_ops_evidence_tool_returns_selected_schema_sections(
    ...
    tools = await tools_for_input(module, card_ids[0], source_input)
