...
| 최종 M1 hybrid priority contract | 7 | 최종 agent 계약: current-best 0.65 + M1 specialist 0.35 | agent UI/API가 정렬과 level 판단에 우선 사용하는 필드 |
...
### 최종 M1 hybrid priority contract (7)

`priority_score`, `priority_level`, `priority_source`, `priority_high_label`, `m1_hybrid_priority_score`, `m1_hybrid_priority_level`, `m1_priority_agreement`
