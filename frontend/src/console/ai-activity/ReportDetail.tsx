...
export function ReportDetail({ item, onClose }: Props) {
  ...
  return <SurfaceCard action={<Button aria-label="상세 닫기" icon="x" onClick={onClose} />} className="activity-detail activity-detail-with-footer" title="보고서 상세">
    ...
    <div className="activity-detail-footer detail-actions"><a className="ops-button button-ghost" download={fileName} href={downloadUrl}>원본 {extension.toUpperCase()} 다운로드</a></div>
  </SurfaceCard>
}
