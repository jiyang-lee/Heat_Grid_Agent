...
import { useArtifacts, useCreateAgentRun } from '../api/hooks'
      ...
      {run && ops && (
        <div className="wo-card">
          ...
          <div className="wo-sec">
            ...
            <div className="wo-v">{ops.summary}</div>
          </div>
          <div className="wo-sec">
            <div className="wo-k">조치 계획</div>
            <div className="wo-v pre">{ops.action_plan}</div>
          </div>
          <div className="wo-sec">
            <div className="wo-k">주의</div>
            <div className="wo-v">{ops.caution}</div>
          </div>
        </div>
      )}
