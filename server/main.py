...
def _key(substation_id, window_start: str) -> str:
    return f"{int(substation_id)}_{_slug(window_start)}"
...
def _load() -> pd.DataFrame:
    ...
    pr["key"] = [_key(s, w) for s, w in zip(pr["substation_id"], pr["window_start"])]
