...
flowchart LR
  ...
  AUDIT --> RAW
  RAW --> PRE["전처리<br/>3346 rows x 211 cols"]
...
| full supervised labels | 3346 rows |
| full label 분포 | normal 1818 / pre_fault 1528 |
| full pre_fault bucket | 0-24h 217 / 1-3d 436 / 3-7d 875 |
| raw sensor readings read | 120377 rows |
| raw fault events read | 69 rows |
